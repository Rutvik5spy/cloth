...
const products = [
  {
    id: 1,
    title: "UM Core Hoodie // Orchid Hush",
    price: 1849,
    oldPrice: 2500,
    discount: "26% OFF",
    image:
      "https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcTu56ZlHho3W5N6cXFwjqG80gnk-gEHidE2J8Tzz0jAi2Ee2vfg-R5uDPU8_BL-td15MuR3AZtCyaPgTcULZNch1x8-wdtL0fAXDMHjWzt2CCyq_xE_9hkrOw",
  },
  {
    id: 2,
    title: "UM Core Hoodie // Rosette",
    price: 1849,
    oldPrice: 2500,
    discount: "26% OFF",
    image:
      "https://www.urbanmonkey.com/cdn/shop/files/Urban-monkey-6039-867035.jpg?v=1733829637&width=400",
  },
  {
    id: 3,
    title: "Future Hoodie",
    ...
    discount: "28% OFF",
    image:
      "https://cdn.shopify.com/s/files/1/0661/7423/files/rich-kid-denim-washed-blue-um24a-de-006-xs-835713_400x.jpg?v=1734935737",
  },
  {
    id: 4,
    ...
    discount: "16% OFF",
    image:
      "https://cdn.shopify.com/s/files/1/0661/7423/files/Urban-monkey-4742-314615_400x.jpg?v=1733830009",
  },
];

export default function NoRestock() {
  const { addToCart, addToWishlist } = useContext(CartContext);
  const { searchTerm } = useContext(SearchContext); // ✅ global search
    ...
    <div className="px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {filteredProducts.map((p) => (
          <div
            key={p.id}
            className="relative rounded-xl shadow hover:shadow-lg transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 p-4 flex flex-col"
          >
